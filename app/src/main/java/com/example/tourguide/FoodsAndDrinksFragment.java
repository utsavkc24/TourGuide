...
public class FoodsAndDrinksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.add(new Custom(R.string.biryani_mahal, R.string.biryani_mahal_description, R.string.biryani_mahal_location, R.string.bihar_museum_timing, R.drawable.biryani_mahal_image));
